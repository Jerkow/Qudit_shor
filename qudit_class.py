...
def int_to_qudits(x,d,q):
    """ Assigns x (decimal) to a q-sized qudit register with qudit dimensions d """
...
q1 = qudit(4,amp=(0,1,0,0), phase=(0,0,0,0))
q2 = qudit(4,amp=(1,1,1,1), phase=(0,0,0,0))
...
q1.hadamard()
print(q1.phases)
print(q1.phases[0] == q1.phases[1])
'''
'''
print(qudit(4,3).values)

r1 = int_to_qudits(5,4,3)
r2 = int_to_qudits(20,4,3)
